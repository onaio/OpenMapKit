...
/**
 * ('mda_status'='all_received' +'mda_status'='some_received'+'mda_status'='none_received')
 */
public class MacepaFoundIndicator extends OSMIndicator {
    public static final String NAME = "MacepaFoundIndicator";

    public MacepaFoundIndicator(Context context, Map<String, Map<Long, OSMElement>> mappedData) {
    ...
    public String getTitle() {
        return context.getResources().getString(R.string.indicatorMacepaFound);
    }
}